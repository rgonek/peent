...
const reducer = ( state = initialState, action ) => {
    switch ( action.type ) {
        case actionTypes.ADD_TRANSACTION_START: return addTransactionStart( state, action );
        case actionTypes.ADD_TRANSACTION_SUCCESS: return addTransactionSuccess( state, action );
        case actionTypes.ADD_TRANSACTION_FAIL: return addTransactionFail( state, action );

        case actionTypes.UPDATE_TRANSACTION_START: return updateTransactionStart( state, action );
        case actionTypes.UPDATE_TRANSACTION_SUCCESS: return updateTransactionSuccess( state, action );
        case actionTypes.UPDATE_TRANSACTION_FAIL: return updateTransactionFail( state, action );
        ...
        case actionTypes.FETCH_TRANSACTION_START: return fetchTransactionStart( state, action );
        case actionTypes.FETCH_TRANSACTION_SUCCESS: return fetchTransactionSuccess( state, action );
        case actionTypes.FETCH_TRANSACTION_FAIL: return fetchTransactionFail( state, action );
