        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Symbol = table.Column<string>(maxLength: 12, nullable: false),
                    DecimalPlaces = table.Column<int>(maxLength: 18, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrencyId = table.Column<int>(nullable: false),
                    ForeignAmount = table.Column<decimal>(type: "decimal(38,18)", nullable: true),
                    ForeignCurrencyId = table.Column<int>(nullable: false),
                    ...
                    DeletionDate = table.Column<DateTime>(nullable: true),
                    DeletedById = table.Column<string>(nullable: true),
                    TransactionId1 = table.Column<long>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TransactionEntries_Currencies_CurrencyId",
                        column: x => x.CurrencyId,
                        principalTable: "Currencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransactionEntries_CurrencyId",
                table: "TransactionEntries",
                column: "CurrencyId");
