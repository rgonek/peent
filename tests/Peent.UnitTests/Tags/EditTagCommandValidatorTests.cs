...
namespace Peent.UnitTests.Tags
{
    public class EditTagCommandValidatorTests
    {
        private readonly EditTagCommandValidator _validator =
            new EditTagCommandValidator(new AlwaysExistsValidatorProvider(), new AlwaysUniqueValidatorProvider());
        ...
        public void when_is_duplicated__should_have_error()
            => new EditTagCommandValidator(new AlwaysExistsValidatorProvider(), new AlwaysDuplicatedValidatorProvider())
        ...
        public void when_does_not_exists__should_have_error()
            => new EditTagCommandValidator(new AlwaysNotExistsValidatorProvider(), new AlwaysUniqueValidatorProvider())
